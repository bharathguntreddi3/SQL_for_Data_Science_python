import mysql.connector   #import the necessary modules

mydb = mysql.connector.connect(host="localhost", user="root", password="Hayan12!@", port=3306, database="my_poke_shop")
print("Connected to Mysql Database")
print("   ")

mycursor = mydb.cursor()

# mycursor.execute("CREATE DATABASE my_poke_shop")
...
# mycursor.execute("CREATE TABLE pokemons(column_0 DOUBLE, Name VARCHAR(100), Type_1 VARCHAR(100), Type_2 VARCHAR(100), HP DOUBLE, Attack DOUBLE, Defense DOUBLE, Sp_Atk DOUBLE, Sp_Def DOUBLE, Speed DOUBLE, Generation DOUBLE, Legendary VARCHAR(100));")

sql = "INSERT INTO pokemons(column_0, Name, Type_1, Type_2, HP, Attack, Defense, Sp_Atk, Sp_Def, Speed, Generation, Legendary) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,)"
...
val = [
    ...
    (7,'Squirtle','Water',None,44,48,65,50,64,43,1,'False'),
    (8,'Wartortle','Water',None,59,63,80,65,80,58,1,'False'),
    (9,'Blastoise','Water',None,79,83,100,85,105,78,1,'False'),
    (9,'BlastoiseMega Blastoise','Water',None,79,103,120,135,115,78,1,'False'),
    (10,'Caterpie','Bug',None,45,30,35,20,20,45,1,'False'),
    (11,'Metapod','Bug',None,50,20,55,25,25,30,1,'False'),
    ...
    (19,'Rattata','Normal',None,30,56,35,25,35,72,1,'False'),
    (20,'Raticate','Normal',None,55,81,60,50,70,97,1,'False'),
    (21,'Spearow','Normal','Flying',40,60,30,31,31,70,1,'False'),
    (22,'Fearow','Normal','Flying',65,90,65,61,61,100,1,'False'),
    (23,'Ekans','Poison',None,35,60,44,40,54,55,1,'False'),
    (24,'Arbok','Poison',None,60,85,69,65,79,80,1,'False'),
    (25,'Pikachu','Electric',None,35,55,40,50,50,90,1,'False'),
    (26,'Raichu','Electric',None,60,90,55,90,80,110,1,'False'),
    (27,'Sandshrew','Ground',None,50,75,85,20,30,40,1,'False'),
    (28,'Sandslash','Ground',None,75,100,110,45,55,65,1,'False'),
    (29,'Nidoran (Female)','Poison',None,55,47,52,40,40,41,1,'False'),
    (30,'Nidorina','Poison',None,70,62,67,55,55,56,1,'False'),
    (31,'Nidoqueen','Poison','Ground',90,92,87,75,85,76,1,'False'),
    (32,'Nidoran (Male)','Poison',None,46,57,40,40,40,50,1,'False'),
    (33,'Nidorino','Poison',None,61,72,57,55,55,65,1,'False'),
    (34,'Nidoking','Poison','Ground',81,102,77,85,75,85,1,'False'),
    (35,'Clefairy','Fairy',None,70,45,48,60,65,35,1,'False'),
    (36,'Clefable','Fairy',None,95,70,73,95,90,60,1,'False'),
    (37,'Vulpix','Fire',None,38,41,40,50,65,65,1,'False'),
    (38,'Ninetales','Fire',None,73,76,75,81,100,100,1,'False'),
    ...
    (50,'Diglett','Ground',None,10,55,25,35,45,95,1,'False'),
    (51,'Dugtrio','Ground',None,35,80,50,50,70,120,1,'False'),
    (52,'Meowth','Normal',None,40,45,35,40,40,90,1,'False'),
    (53,'Persian','Normal',None,65,70,60,65,65,115,1,'False'),
    (54,'Psyduck','Water',None,50,52,48,65,50,55,1,'False'),
    (55,'Golduck','Water',None,80,82,78,95,80,85,1,'False'),
    (56,'Mankey','Fighting',None,40,80,35,35,45,70,1,'False'),
    (57,'Primeape','Fighting',None,65,105,60,60,70,95,1,'False'),
    (58,'Growlithe','Fire',None,55,70,45,70,50,60,1,'False'),
    (59,'Arcanine','Fire',None,90,110,80,100,80,95,1,'False'),
    (60,'Poliwag','Water',None,40,50,40,40,40,90,1,'False'),
    (61,'Poliwhirl','Water',None,65,65,65,50,50,90,1,'False'),
    (62,'Poliwrath','Water','Fighting',90,95,95,70,90,70,1,'False'),
    (63,'Abra','Psychic',None,25,20,15,105,55,90,1,'False'),
    (64,'Kadabra','Psychic',None,40,35,30,120,70,105,1,'False'),
    (65,'Alakazam','Psychic',None,55,50,45,135,95,120,1,'False'),
    (65,'AlakazamMega Alakazam','Psychic',None,55,50,65,175,95,150,1,'False'),
    (66,'Machop','Fighting',None,70,80,50,35,35,35,1,'False'),
    (67,'Machoke','Fighting',None,80,100,70,50,60,45,1,'False'),
    (68,'Machamp','Fighting',None,90,130,80,65,85,55,1,'False'),
    ...
    (77,'Ponyta','Fire',None,50,85,55,65,65,90,1,'False'),
    (78,'Rapidash','Fire',None,65,100,70,80,80,105,1,'False'),
    ...
    (86,'Seel','Water',None,65,45,55,45,70,45,1,'False'),
    (87,'Dewgong','Water','Ice',90,70,80,70,95,70,1,'False'),
    (88,'Grimer','Poison',None,80,80,50,40,50,25,1,'False'),
    (89,'Muk','Poison',None,105,105,75,65,100,50,1,'False'),
    (90,'Shellder','Water',None,30,65,100,45,25,40,1,'False'),
    ...
    (96,'Drowzee','Psychic',None,60,48,45,43,90,42,1,'False'),
    (97,'Hypno','Psychic',None,85,73,70,73,115,67,1,'False'),
    (98,'Krabby','Water',None,30,105,90,25,25,50,1,'False'),
    (99,'Kingler','Water',None,55,130,115,50,50,75,1,'False'),
    (100,'Voltorb','Electric',None,40,30,50,55,55,100,1,'False'),
    (101,'Electrode','Electric',None,60,50,70,80,80,140,1,'False'),
    (102,'Exeggcute','Grass','Psychic',60,40,80,60,45,40,1,'False'),
    (103,'Exeggutor','Grass','Psychic',95,95,85,125,65,55,1,'False'),
    (104,'Cubone','Ground',None,50,50,95,40,50,35,1,'False'),
    (105,'Marowak','Ground',None,60,80,110,50,80,45,1,'False'),
    (106,'Hitmonlee','Fighting',None,50,120,53,35,110,87,1,'False'),
    (107,'Hitmonchan','Fighting',None,50,105,79,35,110,76,1,'False'),
    (108,'Lickitung','Normal',None,90,55,75,60,75,30,1,'False'),
    (109,'Koffing','Poison',None,40,65,95,60,45,35,1,'False'),
    (110,'Weezing','Poison',None,65,90,120,85,70,60,1,'False'),
    (111,'Rhyhorn','Ground','Rock',80,85,95,30,30,25,1,'False'),
    (112,'Rhydon','Ground','Rock',105,130,120,45,45,40,1,'False'),
    (113,'Chansey','Normal',None,250,5,5,35,105,50,1,'False'),
    (114,'Tangela','Grass',None,65,55,115,100,40,60,1,'False'),
    (115,'Kangaskhan','Normal',None,105,95,80,40,80,90,1,'False'),
    (115,'KangaskhanMega Kangaskhan','Normal',None,105,125,100,60,100,100,1,'False'),
    (116,'Horsea','Water',None,30,40,70,70,25,60,1,'False'),
    (117,'Seadra','Water',None,55,65,95,95,45,85,1,'False'),
    (118,'Goldeen','Water',None,45,67,60,35,50,63,1,'False'),
    (119,'Seaking','Water',None,80,92,65,65,80,68,1,'False'),
    (120,'Staryu','Water',None,30,45,55,70,55,85,1,'False'),
    ...
    (125,'Electabuzz','Electric',None,65,83,57,95,85,105,1,'False'),
    (126,'Magmar','Fire',None,65,95,57,100,85,93,1,'False'),
    (127,'Pinsir','Bug',None,65,125,100,55,70,85,1,'False'),
    (127,'PinsirMega Pinsir','Bug','Flying',65,155,120,65,90,105,1,'False'),
    (128,'Tauros','Normal',None,75,100,95,40,70,110,1,'False'),
    (129,'Magikarp','Water',None,20,10,55,15,20,80,1,'False'),
    ...
    (132,'Ditto','Normal',None,48,48,48,48,48,48,1,'False'),
    (133,'Eevee','Normal',None,55,55,50,45,65,55,1,'False'),
    (134,'Vaporeon','Water',None,130,65,60,110,95,65,1,'False'),
    (135,'Jolteon','Electric',None,65,65,60,110,95,130,1,'False'),
    (136,'Flareon','Fire',None,65,130,60,95,110,65,1,'False'),
    (137,'Porygon','Normal',None,65,60,70,85,75,40,1,'False'),
    ...
    (143,'Snorlax','Normal',None,160,110,65,65,110,30,1,'False'),
    ...
    (147,'Dratini','Dragon',None,41,64,45,50,50,50,1,'False'),
    (148,'Dragonair','Dragon',None,61,84,65,70,70,70,1,'False'),
    (149,'Dragonite','Dragon','Flying',91,134,95,100,100,80,1,'False'),
    (150,'Mewtwo','Psychic',None,106,110,90,154,90,130,1,'True'),
    (150,'MewtwoMega Mewtwo X','Psychic','Fighting',106,190,100,154,100,130,1,'True'),
    (150,'MewtwoMega Mewtwo Y','Psychic',None,106,150,70,194,120,140,1,'True'),
    (151,'Mew','Psychic',None,100,100,100,100,100,100,1,'False'),
    (152,'Chikorita','Grass',None,45,49,65,49,65,45,2,'False'),
    (153,'Bayleef','Grass',None,60,62,80,63,80,60,2,'False'),
    (154,'Meganium','Grass',None,80,82,100,83,100,80,2,'False'),
    (155,'Cyndaquil','Fire',None,39,52,43,60,50,65,2,'False'),
    (156,'Quilava','Fire',None,58,64,58,80,65,80,2,'False'),
    (157,'Typhlosion','Fire',None,78,84,78,109,85,100,2,'False'),
    (158,'Totodile','Water',None,50,65,64,44,48,43,2,'False'),
    (159,'Croconaw','Water',None,65,80,80,59,63,58,2,'False'),
    (160,'Feraligatr','Water',None,85,105,100,79,83,78,2,'False'),
    (161,'Sentret','Normal',None,35,46,34,35,45,20,2,'False'),
    (162,'Furret','Normal',None,85,76,64,45,55,90,2,'False'),
    ...
    (172,'Pichu','Electric',None,20,40,15,35,35,60,2,'False'),
    (173,'Cleffa','Fairy',None,50,25,28,45,55,15,2,'False'),
    (174,'Igglybuff','Normal','Fairy',90,30,15,40,20,15,2,'False'),
    (175,'Togepi','Fairy',None,35,20,65,40,65,20,2,'False'),
    ...
    (179,'Mareep','Electric',None,55,40,40,65,45,35,2,'False'),
    (180,'Flaaffy','Electric',None,70,55,55,80,60,45,2,'False'),
    (181,'Ampharos','Electric',None,90,75,85,115,90,55,2,'False'),
    (181,'AmpharosMega Ampharos','Electric','Dragon',90,95,105,165,110,45,2,'False'),
    (182,'Bellossom','Grass',None,75,80,95,90,100,50,2,'False'),
    (183,'Marill','Water','Fairy',70,20,50,20,50,40,2,'False'),
    (184,'Azumarill','Water','Fairy',100,50,80,60,80,50,2,'False'),
    (185,'Sudowoodo','Rock',None,70,100,115,30,65,30,2,'False'),
    (186,'Politoed','Water',None,90,75,75,90,100,70,2,'False'),
    ...
    (190,'Aipom','Normal',None,55,70,55,40,55,85,2,'False'),
    (191,'Sunkern','Grass',None,30,30,30,30,30,30,2,'False'),
    (192,'Sunflora','Grass',None,75,75,55,105,85,30,2,'False'),
    ...
    (196,'Espeon','Psychic',None,65,65,60,130,95,110,2,'False'),
    (197,'Umbreon','Dark',None,95,65,110,60,130,65,2,'False'),
    (198,'Murkrow','Dark','Flying',60,85,42,85,42,91,2,'False'),
    (199,'Slowking','Water','Psychic',95,75,80,100,110,30,2,'False'),
    (200,'Misdreavus','Ghost',None,60,60,60,85,85,85,2,'False'),
    (201,'Unown','Psychic',None,48,72,48,72,48,48,2,'False'),
    (202,'Wobbuffet','Psychic',None,190,33,58,33,58,33,2,'False'),
    (203,'Girafarig','Normal','Psychic',70,80,65,90,65,85,2,'False'),
    (204,'Pineco','Bug',None,50,65,90,35,35,15,2,'False'),
    (205,'Forretress','Bug','Steel',75,90,140,60,60,40,2,'False'),
    (206,'Dunsparce','Normal',None,100,70,70,65,65,45,2,'False'),
    ...
    (209,'Snubbull','Fairy',None,60,80,50,40,40,30,2,'False'),
    (210,'Granbull','Fairy',None,90,120,75,60,60,45,2,'False'),
    ...
    (216,'Teddiursa','Normal',None,60,80,50,50,50,40,2,'False'),
    (217,'Ursaring','Normal',None,90,130,75,75,75,55,2,'False'),
    (218,'Slugma','Fire',None,40,40,40,70,40,20,2,'False'),
    ...
    (223,'Remoraid','Water',None,35,65,35,65,35,65,2,'False'),
    (224,'Octillery','Water',None,75,105,75,105,75,45,2,'False'),
    ...
    (231,'Phanpy','Ground',None,90,60,60,40,40,40,2,'False'),
    (232,'Donphan','Ground',None,90,120,120,60,60,50,2,'False'),
    (233,'Porygon2','Normal',None,85,80,90,105,95,60,2,'False'),
    (234,'Stantler','Normal',None,73,95,62,85,65,85,2,'False'),
    (235,'Smeargle','Normal',None,55,20,35,20,45,75,2,'False'),
    (236,'Tyrogue','Fighting',None,35,35,35,35,35,35,2,'False'),
    (237,'Hitmontop','Fighting',None,50,95,95,35,110,70,2,'False'),
    (238,'Smoochum','Ice','Psychic',45,30,15,85,65,65,2,'False'),
    (239,'Elekid','Electric',None,45,63,37,65,55,95,2,'False'),
    (240,'Magby','Fire',None,45,75,37,70,55,83,2,'False'),
    (241,'Miltank','Normal',None,95,80,105,40,70,100,2,'False'),
    (242,'Blissey','Normal',None,255,10,10,75,135,55,2,'False'),
    (243,'Raikou','Electric',None,90,85,75,115,100,115,2,'True'),
    (244,'Entei','Fire',None,115,115,85,90,75,100,2,'True'),
    (245,'Suicune','Water',None,100,75,115,90,115,85,2,'True'),
    ...
    (252,'Treecko','Grass',None,40,45,35,65,55,70,3,'False'),
    (253,'Grovyle','Grass',None,50,65,45,85,65,95,3,'False'),
    (254,'Sceptile','Grass',None,70,85,65,105,85,120,3,'False'),
    (254,'SceptileMega Sceptile','Grass','Dragon',70,110,75,145,85,145,3,'False'),
    (255,'Torchic','Fire',None,45,60,40,70,50,45,3,'False'),
    ...
    (258,'Mudkip','Water',None,50,70,50,50,50,40,3,'False'),
    ...
    (261,'Poochyena','Dark',None,35,55,35,30,30,35,3,'False'),
    (262,'Mightyena','Dark',None,70,90,70,60,60,70,3,'False'),
    (263,'Zigzagoon','Normal',None,38,30,41,30,41,60,3,'False'),
    (264,'Linoone','Normal',None,78,70,61,50,61,100,3,'False'),
    (265,'Wurmple','Bug',None,45,45,35,20,30,20,3,'False'),
    (266,'Silcoon','Bug',None,50,35,55,25,25,15,3,'False'),
    (267,'Beautifly','Bug','Flying',60,70,50,100,50,65,3,'False'),
    (268,'Cascoon','Bug',None,50,35,55,25,25,15,3,'False'),
    ...
    (273,'Seedot','Grass',None,40,40,50,30,30,30,3,'False'),
    ...
    (285,'Shroomish','Grass',None,60,40,60,40,60,35,3,'False'),
    (286,'Breloom','Grass','Fighting',60,130,80,60,60,70,3,'False'),
    (287,'Slakoth','Normal',None,60,60,60,35,35,30,3,'False'),
    (288,'Vigoroth','Normal',None,80,80,80,55,55,90,3,'False'),
    (289,'Slaking','Normal',None,150,160,100,95,65,100,3,'False'),
    ...
    (293,'Whismur','Normal',None,64,51,23,51,23,28,3,'False'),
    (294,'Loudred','Normal',None,84,71,43,71,43,48,3,'False'),
    (295,'Exploud','Normal',None,104,91,63,91,73,68,3,'False'),
    (296,'Makuhita','Fighting',None,72,60,30,20,30,25,3,'False'),
    (297,'Hariyama','Fighting',None,144,120,60,40,60,50,3,'False'),
    (298,'Azurill','Normal','Fairy',50,20,40,20,40,20,3,'False'),
    (299,'Nosepass','Rock',None,30,45,135,45,90,30,3,'False'),
    (300,'Skitty','Normal',None,50,45,45,35,35,50,3,'False'),
    (301,'Delcatty','Normal',None,70,65,65,55,55,70,3,'False'),
    ...
    (306,'AggronMega Aggron','Steel',None,70,140,230,60,80,50,3,'False'),
    ...
    (309,'Electrike','Electric',None,40,45,40,65,40,65,3,'False'),
    (310,'Manectric','Electric',None,70,75,60,105,60,105,3,'False'),
    (310,'ManectricMega Manectric','Electric',None,70,75,80,135,80,135,3,'False'),
    (311,'Plusle','Electric',None,60,50,40,85,75,95,3,'False'),
    (312,'Minun','Electric',None,60,40,50,75,85,95,3,'False'),
    (313,'Volbeat','Bug',None,65,73,55,47,75,85,3,'False'),
    (314,'Illumise','Bug',None,65,47,55,73,75,85,3,'False'),
    (315,'Roselia','Grass','Poison',50,60,45,100,80,65,3,'False'),
    (316,'Gulpin','Poison',None,70,43,53,43,53,40,3,'False'),
    (317,'Swalot','Poison',None,100,73,83,73,83,55,3,'False'),
    ...
    (320,'Wailmer','Water',None,130,70,35,70,35,60,3,'False'),
    (321,'Wailord','Water',None,170,90,45,90,45,60,3,'False'),
    ...
    (324,'Torkoal','Fire',None,70,85,140,85,70,20,3,'False'),
    (325,'Spoink','Psychic',None,60,25,35,70,80,60,3,'False'),
    (326,'Grumpig','Psychic',None,80,45,65,90,110,80,3,'False'),
    (327,'Spinda','Normal',None,60,60,60,60,60,60,3,'False'),
    (328,'Trapinch','Ground',None,45,100,45,45,45,10,3,'False'),
    (329,'Vibrava','Ground','Dragon',50,70,50,50,50,70,3,'False'),
    (330,'Flygon','Ground','Dragon',80,100,80,80,80,100,3,'False'),
    (331,'Cacnea','Grass',None,50,85,40,85,40,35,3,'False'),
    ...
    (335,'Zangoose','Normal',None,73,115,60,60,60,90,3,'False'),
    (336,'Seviper','Poison',None,73,100,60,100,60,65,3,'False'),
    ...
    (341,'Corphish','Water',None,43,80,65,50,35,35,3,'False'),
    ...
    (349,'Feebas','Water',None,20,15,20,10,55,80,3,'False'),
    (350,'Milotic','Water',None,95,60,79,100,125,81,3,'False'),
    (351,'Castform','Normal',None,70,70,70,70,70,70,3,'False'),
    (352,'Kecleon','Normal',None,60,90,70,60,120,40,3,'False'),
    (353,'Shuppet','Ghost',None,44,75,35,63,33,45,3,'False'),
    (354,'Banette','Ghost',None,64,115,65,83,63,65,3,'False'),
    (354,'BanetteMega Banette','Ghost',None,64,165,75,93,83,75,3,'False'),
    (355,'Duskull','Ghost',None,20,40,90,30,90,25,3,'False'),
    (356,'Dusclops','Ghost',None,40,70,130,60,130,25,3,'False'),
    (357,'Tropius','Grass','Flying',99,68,83,72,87,51,3,'False'),
    (358,'Chimecho','Psychic',None,65,50,70,95,80,65,3,'False'),
    (359,'Absol','Dark',None,65,130,60,75,60,75,3,'False'),
    (359,'AbsolMega Absol','Dark',None,65,150,60,115,60,115,3,'False'),
    (360,'Wynaut','Psychic',None,95,23,48,23,48,23,3,'False'),
    (361,'Snorunt','Ice',None,50,50,50,50,50,50,3,'False'),
    (362,'Glalie','Ice',None,80,80,80,80,80,80,3,'False'),
    (362,'GlalieMega Glalie','Ice',None,80,120,80,120,80,100,3,'False'),
    ...
    (366,'Clamperl','Water',None,35,64,85,74,55,32,3,'False'),
    (367,'Huntail','Water',None,55,104,105,94,75,52,3,'False'),
    (368,'Gorebyss','Water',None,55,84,105,114,75,52,3,'False'),
    (369,'Relicanth','Water','Rock',100,90,130,45,65,55,3,'False'),
    (370,'Luvdisc','Water',None,43,30,55,40,65,97,3,'False'),
    (371,'Bagon','Dragon',None,45,75,60,40,30,50,3,'False'),
    (372,'Shelgon','Dragon',None,65,95,100,60,50,50,3,'False'),
    ...
    (377,'Regirock','Rock',None,80,100,200,50,100,50,3,'True'),
    (378,'Regice','Ice',None,80,50,100,100,200,50,3,'True'),
    (379,'Registeel','Steel',None,80,75,150,75,150,50,3,'True'),
    ...
    (382,'Kyogre','Water',None,100,100,90,150,140,90,3,'True'),
    (382,'KyogrePrimal Kyogre','Water',None,100,150,90,180,160,90,3,'True'),
    (383,'Groudon','Ground',None,100,150,140,100,90,90,3,'True'),
    ...
    (386,'DeoxysNormal Forme','Psychic',None,50,150,50,150,50,150,3,'True'),
    (386,'DeoxysAttack Forme','Psychic',None,50,180,20,180,20,150,3,'True'),
    (386,'DeoxysDefense Forme','Psychic',None,50,70,160,70,160,90,3,'True'),
    (386,'DeoxysSpeed Forme','Psychic',None,50,95,90,95,90,180,3,'True'),
    (387,'Turtwig','Grass',None,55,68,64,45,55,31,4,'False'),
    (388,'Grotle','Grass',None,75,89,85,55,65,36,4,'False'),
    (389,'Torterra','Grass','Ground',95,109,105,75,85,56,4,'False'),
    (390,'Chimchar','Fire',None,44,58,44,58,44,61,4,'False'),
    (391,'Monferno','Fire','Fighting',64,78,52,78,52,81,4,'False'),
    (392,'Infernape','Fire','Fighting',76,104,71,104,71,108,4,'False'),
    (393,'Piplup','Water',None,53,51,53,61,56,40,4,'False'),
    (394,'Prinplup','Water',None,64,66,68,81,76,50,4,'False'),
    ...
    (399,'Bidoof','Normal',None,59,45,40,35,40,31,4,'False'),
    (400,'Bibarel','Normal','Water',79,85,60,55,60,71,4,'False'),
    (401,'Kricketot','Bug',None,37,25,41,25,41,25,4,'False'),
    (402,'Kricketune','Bug',None,77,85,51,55,51,65,4,'False'),
    (403,'Shinx','Electric',None,45,65,34,40,34,45,4,'False'),
    (404,'Luxio','Electric',None,60,85,49,60,49,60,4,'False'),
    (405,'Luxray','Electric',None,80,120,79,95,79,70,4,'False'),
    (406,'Budew','Grass','Poison',40,30,35,50,70,55,4,'False'),
    (407,'Roserade','Grass','Poison',60,70,65,125,105,90,4,'False'),
    (408,'Cranidos','Rock',None,67,125,40,30,30,58,4,'False'),
    (409,'Rampardos','Rock',None,97,165,60,65,50,58,4,'False'),
    (410,'Shieldon','Rock','Steel',30,42,118,42,88,30,4,'False'),
    (411,'Bastiodon','Rock','Steel',60,52,168,47,138,30,4,'False'),
    (412,'Burmy','Bug',None,40,29,45,29,45,36,4,'False'),
    ...
    (417,'Pachirisu','Electric',None,60,45,70,45,90,95,4,'False'),
    (418,'Buizel','Water',None,55,65,35,60,30,85,4,'False'),
    (419,'Floatzel','Water',None,85,105,55,85,50,115,4,'False'),
    (420,'Cherubi','Grass',None,45,35,45,62,53,35,4,'False'),
    (421,'Cherrim','Grass',None,70,60,70,87,78,85,4,'False'),
    (422,'Shellos','Water',None,76,48,48,57,62,34,4,'False'),
    (423,'Gastrodon','Water','Ground',111,83,68,92,82,39,4,'False'),
    (424,'Ambipom','Normal',None,75,100,66,60,66,115,4,'False'),
    (425,'Drifloon','Ghost','Flying',90,50,34,60,44,70,4,'False'),
    (426,'Drifblim','Ghost','Flying',150,80,44,90,54,80,4,'False'),
    (427,'Buneary','Normal',None,55,66,44,44,56,85,4,'False'),
    (428,'Lopunny','Normal',None,65,76,84,54,96,105,4,'False'),
    (428,'LopunnyMega Lopunny','Normal','Fighting',65,136,94,54,96,135,4,'False'),
    (429,'Mismagius','Ghost',None,60,60,60,105,105,105,4,'False'),
    (430,'Honchkrow','Dark','Flying',100,125,52,105,52,71,4,'False'),
    (431,'Glameow','Normal',None,49,55,42,42,37,85,4,'False'),
    (432,'Purugly','Normal',None,71,82,64,64,59,112,4,'False'),
    (433,'Chingling','Psychic',None,45,30,50,65,50,45,4,'False'),
    ...
    (438,'Bonsly','Rock',None,50,80,95,10,45,10,4,'False'),
    (439,'Mime Jr.','Psychic','Fairy',20,25,45,70,90,60,4,'False'),
    (440,'Happiny','Normal',None,100,5,5,15,65,30,4,'False'),
    ...
    (446,'Munchlax','Normal',None,135,85,40,40,85,5,4,'False'),
    (447,'Riolu','Fighting',None,40,70,40,35,40,60,4,'False'),
    ...
    (449,'Hippopotas','Ground',None,68,72,78,38,42,32,4,'False'),
    (450,'Hippowdon','Ground',None,108,112,118,68,72,47,4,'False'),
    ...
    (455,'Carnivine','Grass',None,74,100,72,90,72,46,4,'False'),
    (456,'Finneon','Water',None,49,49,56,49,61,66,4,'False'),
    (457,'Lumineon','Water',None,69,69,76,69,86,91,4,'False'),
    ...
    (463,'Lickilicky','Normal',None,110,85,95,80,95,50,4,'False'),
    (464,'Rhyperior','Ground','Rock',115,140,130,55,55,40,4,'False'),
    (465,'Tangrowth','Grass',None,100,100,125,110,50,50,4,'False'),
    (466,'Electivire','Electric',None,75,123,67,95,85,95,4,'False'),
    (467,'Magmortar','Fire',None,75,95,67,125,95,83,4,'False'),
    (468,'Togekiss','Fairy','Flying',85,50,95,120,115,80,4,'False'),
    (469,'Yanmega','Bug','Flying',86,76,86,116,56,95,4,'False'),
    (470,'Leafeon','Grass',None,65,110,130,60,65,95,4,'False'),
    (471,'Glaceon','Ice',None,65,60,110,130,95,65,4,'False'),
    (472,'Gliscor','Ground','Flying',75,95,125,45,75,95,4,'False'),
    (473,'Mamoswine','Ice','Ground',110,130,80,70,60,80,4,'False'),
    (474,'Porygon-Z','Normal',None,85,80,70,135,75,90,4,'False'),
    ...
    (477,'Dusknoir','Ghost',None,45,100,135,65,135,45,4,'False'),
    ...
    (480,'Uxie','Psychic',None,75,75,130,75,130,95,4,'True'),
    (481,'Mesprit','Psychic',None,80,105,105,105,105,80,4,'True'),
    (482,'Azelf','Psychic',None,75,125,70,125,70,115,4,'True'),
    ...
    (486,'Regigigas','Normal',None,110,160,110,80,110,100,4,'True'),
    ...
    (488,'Cresselia','Psychic',None,120,70,120,75,130,85,4,'False'),
    (489,'Phione','Water',None,80,80,80,80,80,80,4,'False'),
    (490,'Manaphy','Water',None,100,100,100,100,100,100,4,'False'),
    (491,'Darkrai','Dark',None,70,90,90,135,90,125,4,'True'),
    (492,'ShayminLand Forme','Grass',None,100,100,100,100,100,100,4,'True'),
    (492,'ShayminSky Forme','Grass','Flying',100,103,75,120,75,127,4,'True'),
    (493,'Arceus','Normal',None,120,120,120,120,120,120,4,'True'),
    (494,'Victini','Psychic','Fire',100,100,100,100,100,100,5,'True'),
    (495,'Snivy','Grass',None,45,45,55,45,55,63,5,'False'),
    (496,'Servine','Grass',None,60,60,75,60,75,83,5,'False'),
    (497,'Serperior','Grass',None,75,75,95,75,95,113,5,'False'),
    (498,'Tepig','Fire',None,65,63,45,45,45,45,5,'False'),
    (499,'Pignite','Fire','Fighting',90,93,55,70,55,55,5,'False'),
    (500,'Emboar','Fire','Fighting',110,123,65,100,65,65,5,'False'),
    (501,'Oshawott','Water',None,55,55,45,63,45,45,5,'False'),
    (502,'Dewott','Water',None,75,75,60,83,60,60,5,'False'),
    (503,'Samurott','Water',None,95,100,85,108,70,70,5,'False'),
    (504,'Patrat','Normal',None,45,55,39,35,39,42,5,'False'),
    (505,'Watchog','Normal',None,60,85,69,60,69,77,5,'False'),
    (506,'Lillipup','Normal',None,45,60,45,25,45,55,5,'False'),
    (507,'Herdier','Normal',None,65,80,65,35,65,60,5,'False'),
    (508,'Stoutland','Normal',None,85,110,90,45,90,80,5,'False'),
    (509,'Purrloin','Dark',None,41,50,37,50,37,66,5,'False'),
    (510,'Liepard','Dark',None,64,88,50,88,50,106,5,'False'),
    (511,'Pansage','Grass',None,50,53,48,53,48,64,5,'False'),
    (512,'Simisage','Grass',None,75,98,63,98,63,101,5,'False'),
    (513,'Pansear','Fire',None,50,53,48,53,48,64,5,'False'),
    (514,'Simisear','Fire',None,75,98,63,98,63,101,5,'False'),
    (515,'Panpour','Water',None,50,53,48,53,48,64,5,'False'),
    (516,'Simipour','Water',None,75,98,63,98,63,101,5,'False'),
    (517,'Munna','Psychic',None,76,25,45,67,55,24,5,'False'),
    (518,'Musharna','Psychic',None,116,55,85,107,95,29,5,'False'),
    ...
    (522,'Blitzle','Electric',None,45,60,32,50,32,76,5,'False'),
    (523,'Zebstrika','Electric',None,75,100,63,80,63,116,5,'False'),
    (524,'Roggenrola','Rock',None,55,75,85,25,25,15,5,'False'),
    (525,'Boldore','Rock',None,70,105,105,50,40,20,5,'False'),
    (526,'Gigalith','Rock',None,85,135,130,60,80,25,5,'False'),
    (527,'Woobat','Psychic','Flying',55,45,43,55,43,72,5,'False'),
    (528,'Swoobat','Psychic','Flying',67,57,55,77,55,114,5,'False'),
    (529,'Drilbur','Ground',None,60,85,40,30,45,68,5,'False'),
    (530,'Excadrill','Ground','Steel',110,135,60,50,65,88,5,'False'),
    (531,'Audino','Normal',None,103,60,86,60,86,50,5,'False'),
    (531,'AudinoMega Audino','Normal','Fairy',103,60,126,80,126,50,5,'False'),
    (532,'Timburr','Fighting',None,75,80,55,25,35,35,5,'False'),
    (533,'Gurdurr','Fighting',None,85,105,85,40,50,40,5,'False'),
    (534,'Conkeldurr','Fighting',None,105,140,95,55,65,45,5,'False'),
    (535,'Tympole','Water',None,50,50,40,50,40,64,5,'False'),
    (536,'Palpitoad','Water','Ground',75,65,55,65,55,69,5,'False'),
    (537,'Seismitoad','Water','Ground',105,95,75,85,75,74,5,'False'),
    (538,'Throh','Fighting',None,120,100,85,30,85,45,5,'False'),
    (539,'Sawk','Fighting',None,75,125,75,30,75,85,5,'False'),
    ...
    (548,'Petilil','Grass',None,45,35,50,70,50,30,5,'False'),
    (549,'Lilligant','Grass',None,70,60,75,110,75,90,5,'False'),
    (550,'Basculin','Water',None,70,92,65,80,55,98,5,'False'),
    ...
    (554,'Darumaka','Fire',None,70,90,45,15,45,50,5,'False'),
    (555,'DarmanitanStandard Mode','Fire',None,105,140,55,30,55,95,5,'False'),
    (555,'DarmanitanZen Mode','Fire','Psychic',105,30,105,140,105,55,5,'False'),
    (556,'Maractus','Grass',None,75,86,67,106,67,60,5,'False'),
    ...
    (562,'Yamask','Ghost',None,38,30,85,55,65,30,5,'False'),
    (563,'Cofagrigus','Ghost',None,58,50,145,95,105,30,5,'False'),
    ...
    (568,'Trubbish','Poison',None,50,50,62,40,62,65,5,'False'),
    (569,'Garbodor','Poison',None,80,95,82,60,82,75,5,'False'),
    (570,'Zorua','Dark',None,40,65,40,80,40,65,5,'False'),
    (571,'Zoroark','Dark',None,60,105,60,120,60,105,5,'False'),
    (572,'Minccino','Normal',None,55,50,40,40,40,75,5,'False'),
    (573,'Cinccino','Normal',None,75,95,60,65,60,115,5,'False'),
    (574,'Gothita','Psychic',None,45,30,50,55,65,45,5,'False'),
    (575,'Gothorita','Psychic',None,60,45,70,75,85,55,5,'False'),
    (576,'Gothitelle','Psychic',None,70,55,95,95,110,65,5,'False'),
    (577,'Solosis','Psychic',None,45,30,40,105,50,20,5,'False'),
    (578,'Duosion','Psychic',None,65,40,50,125,60,30,5,'False'),
    (579,'Reuniclus','Psychic',None,110,65,75,125,85,30,5,'False'),
    (580,'Ducklett','Water','Flying',62,44,50,44,50,55,5,'False'),
    (581,'Swanna','Water','Flying',75,87,63,87,63,98,5,'False'),
    (582,'Vanillite','Ice',None,36,50,50,65,60,44,5,'False'),
    (583,'Vanillish','Ice',None,51,65,65,80,75,59,5,'False'),
    (584,'Vanilluxe','Ice',None,71,95,85,110,95,79,5,'False'),
    ...
    (588,'Karrablast','Bug',None,50,75,45,40,45,60,5,'False'),
    ...
    (594,'Alomomola','Water',None,165,75,80,40,45,65,5,'False'),
    ...
    (599,'Klink','Steel',None,40,55,70,45,60,30,5,'False'),
    (600,'Klang','Steel',None,60,80,95,70,85,50,5,'False'),
    (601,'Klinklang','Steel',None,60,100,115,70,85,90,5,'False'),
    (602,'Tynamo','Electric',None,35,55,40,45,40,60,5,'False'),
    (603,'Eelektrik','Electric',None,65,85,70,75,70,40,5,'False'),
    (604,'Eelektross','Electric',None,85,115,80,105,80,50,5,'False'),
    (605,'Elgyem','Psychic',None,55,55,55,85,55,30,5,'False'),
    (606,'Beheeyem','Psychic',None,75,75,75,125,95,40,5,'False'),
    ...
    (610,'Axew','Dragon',None,46,87,60,30,40,57,5,'False'),
    (611,'Fraxure','Dragon',None,66,117,70,40,50,67,5,'False'),
    (612,'Haxorus','Dragon',None,76,147,90,60,70,97,5,'False'),
    (613,'Cubchoo','Ice',None,55,70,40,60,40,40,5,'False'),
    (614,'Beartic','Ice',None,95,110,80,70,80,50,5,'False'),
    (615,'Cryogonal','Ice',None,70,50,30,95,135,105,5,'False'),
    (616,'Shelmet','Bug',None,50,40,85,40,65,25,5,'False'),
    (617,'Accelgor','Bug',None,80,70,40,100,60,145,5,'False'),
    (618,'Stunfisk','Ground','Electric',109,66,84,81,99,32,5,'False'),
    (619,'Mienfoo','Fighting',None,45,85,50,55,50,65,5,'False'),
    (620,'Mienshao','Fighting',None,65,125,60,95,60,105,5,'False'),
    (621,'Druddigon','Dragon',None,77,120,90,60,90,48,5,'False'),
    ...
    (626,'Bouffalant','Normal',None,95,110,95,40,95,55,5,'False'),
    ...
    (631,'Heatmor','Fire',None,85,97,66,105,66,65,5,'False'),
    ...
    (641,'TornadusIncarnate Forme','Flying',None,79,115,70,125,80,111,5,'True'),
    (641,'TornadusTherian Forme','Flying',None,79,100,80,110,90,121,5,'True'),
    ...
    (650,'Chespin','Grass',None,56,61,65,48,45,38,6,'False'),
    (651,'Quilladin','Grass',None,61,78,95,56,58,57,6,'False'),
    (652,'Chesnaught','Grass','Fighting',88,107,122,74,75,64,6,'False'),
    (653,'Fennekin','Fire',None,40,45,40,62,60,60,6,'False'),
    (654,'Braixen','Fire',None,59,59,58,90,70,73,6,'False'),
    (655,'Delphox','Fire','Psychic',75,69,72,114,100,104,6,'False'),
    (656,'Froakie','Water',None,41,56,40,62,44,71,6,'False'),
    (657,'Frogadier','Water',None,54,63,52,83,56,97,6,'False'),
    (658,'Greninja','Water','Dark',72,95,67,103,71,122,6,'False'),
    (659,'Bunnelby','Normal',None,38,36,38,32,36,57,6,'False'),
    ...
    (664,'Scatterbug','Bug',None,38,35,40,27,25,35,6,'False'),
    (665,'Spewpa','Bug',None,45,22,60,27,30,29,6,'False'),
    ...
    (669,'Flab̩b̩','Fairy',None,44,38,39,61,79,42,6,'False'),
    (670,'Floette','Fairy',None,54,45,47,75,98,52,6,'False'),
    (671,'Florges','Fairy',None,78,65,68,112,154,75,6,'False'),
    (672,'Skiddo','Grass',None,66,65,48,62,57,52,6,'False'),
    (673,'Gogoat','Grass',None,123,100,62,97,81,68,6,'False'),
    (674,'Pancham','Fighting',None,67,82,62,46,48,43,6,'False'),
    (675,'Pangoro','Fighting','Dark',95,124,78,69,71,58,6,'False'),
    (676,'Furfrou','Normal',None,75,80,60,65,90,102,6,'False'),
    (677,'Espurr','Psychic',None,62,48,54,63,60,68,6,'False'),
    (678,'MeowsticMale','Psychic',None,74,48,76,83,81,104,6,'False'),
    (678,'MeowsticFemale','Psychic',None,74,48,76,83,81,104,6,'False'),
    ...
    (682,'Spritzee','Fairy',None,78,52,60,63,65,23,6,'False'),
    (683,'Aromatisse','Fairy',None,101,72,72,99,89,29,6,'False'),
    (684,'Swirlix','Fairy',None,62,48,66,59,57,49,6,'False'),
    (685,'Slurpuff','Fairy',None,82,80,86,85,75,72,6,'False'),
    ...
    (692,'Clauncher','Water',None,50,53,62,58,63,44,6,'False'),
    (693,'Clawitzer','Water',None,71,73,88,120,89,59,6,'False'),
    ...
    (700,'Sylveon','Fairy',None,95,65,65,110,130,60,6,'False'),
    ...
    (704,'Goomy','Dragon',None,45,50,35,55,75,40,6,'False'),
    (705,'Sliggoo','Dragon',None,68,75,53,83,113,60,6,'False'),
    (706,'Goodra','Dragon',None,90,100,70,110,150,80,6,'False'),
    ...
    (712,'Bergmite','Ice',None,55,69,85,32,35,28,6,'False'),
    (713,'Avalugg','Ice',None,95,117,184,44,46,28,6,'False'),
    (714,'Noibat','Flying','Dragon',40,30,35,45,40,55,6,'False'),
    (715,'Noivern','Flying','Dragon',85,70,80,97,80,123,6,'False'),
    (716,'Xerneas','Fairy',None,126,131,95,131,98,99,6,'True'),
